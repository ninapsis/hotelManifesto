...
var dialog = ["[color=yellow]A guy on a huge, cozy looking hoodie. He is eating some chips[/color]\nYour suit looks great! This place is a bit windy, so it's nice to be covered.",
"[color=yellow]A guy on a huge, cozy looking hoodie. He is eating some chips[/color]\nOn really cold days I like to weat two pairs of socks. But to be honest, none of my socks pairs are actually paired.",
"[color=yellow]A guy on a huge, cozy looking hoodie. He offers you some chips. You take some.[/color]\nYou don't talk much, right? I'm cool with that. You can call me Icaro.",
"[color=yellow]Icaro. You are both eating some chips[/color]\nBy the way, in case you never saw those [shake rate=5 level=10]shadowy[/shake]... people? Ghosts? I dunno.",
...
var quest_dialog = ["Have you killed them all?"]
